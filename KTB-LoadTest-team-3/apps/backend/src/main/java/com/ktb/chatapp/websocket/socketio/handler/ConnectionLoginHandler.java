...
public class ConnectionLoginHandler {
    ...
    public void onConnect(SocketIOClient client, SocketUser user) {
        ...
        try {
            ...
            client.joinRooms(Set.of("user:" + userId, "room-list", socketRoom(client.getSessionId().toString())));
    ...
    public void onDisconnect(SocketIOClient client) {
        ...
        try {
            ...
            client.leaveRooms(Set.of("user:" + userId, "room-list", socketRoom(socketId)));
            client.del("user");
            client.disconnect();
    ...
    private void notifyDuplicateLogin(SocketIOClient client, String userId) {
        ...
        var existingSocket = socketIOServer.getRoomOperations(socketRoom(existingSocketId));

        existingSocket.sendEvent(DUPLICATE_LOGIN, Map.of(
        ...
        new Thread(() -> {
            try {
                ...
                existingSocket.sendEvent(SESSION_ENDED, Map.of(
